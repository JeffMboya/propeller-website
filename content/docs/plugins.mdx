...
Add `propeller-plugin-sdk` to your `Cargo.toml`. A complete example is in [`examples/plugin-auth/Cargo.toml`](https://github.com/absmach/propeller/blob/main/examples/plugin-auth/Cargo.toml).

Implement the `Plugin` trait and call `register_plugin!`. A full working implementation is in [`examples/plugin-auth/src/lib.rs`](https://github.com/absmach/propeller/blob/main/examples/plugin-auth/src/lib.rs).
...
A complete `Cargo.toml` is in [`examples/proplet-plugin-example/Cargo.toml`](https://github.com/absmach/propeller/blob/main/examples/proplet-plugin-example/Cargo.toml), and the full implementation is in [`examples/proplet-plugin-example/src/lib.rs`](https://github.com/absmach/propeller/blob/main/examples/proplet-plugin-example/src/lib.rs).
